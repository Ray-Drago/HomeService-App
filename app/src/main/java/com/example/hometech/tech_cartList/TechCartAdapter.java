...
public class TechCartAdapter extends RecyclerView.Adapter<TechCartAdapter.MyViewHolder>{
    ...
    public TechCartAdapter(Context ctx, ArrayList<TechCartDataModel> dataModelArrayList){
        c = ctx;
    ...
    @NonNull
    @Override
    public TechCartAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.list_cart_item, parent, false);
        TechCartAdapter.MyViewHolder holder = new MyViewHolder(view);
        return holder;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull TechCartAdapter.MyViewHolder holder, final int position) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (status[0].equals("1")) {
                            ...
                            c.startActivity(new Intent(c, TechListCartActivity.class));
                            ((Activity)c).finish();
                        }
                    }
                },
