package com.example.hometech.user.Mechanic;
...
public class MechAdapter extends RecyclerView.Adapter<MechAdapter.MyViewHolder>implements Filterable {
    private LayoutInflater inflater;
    private ArrayList<MechData> dataModelArrayList;
    private ArrayList<MechData> dataModelArrayListFiltered;
    Context c;

    public MechAdapter(Context ctx, ArrayList<MechData> dataModelArrayList) {
        c = ctx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final MechData product = dataModelArrayListFiltered.get(position);
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MechData p = dataModelArrayList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<MechData> filteredList = new ArrayList<>();
                    for (MechData row : dataModelArrayList) {
