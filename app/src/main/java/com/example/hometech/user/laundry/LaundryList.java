...
public class LaundryList extends AppCompatActivity {
    ...
    String url = Config.baseURL+"laundry.php";
    LaundryAdapter laundryAdapter;
    ArrayList<LaundryData>arrayList;
    Context c ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                laundryAdapter.getFilter().filter(query);
                return false;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laundy);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(LaundryList.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void setupRecycler(){
        ...
        laundryAdapter = new LaundryAdapter(this,arrayList);
