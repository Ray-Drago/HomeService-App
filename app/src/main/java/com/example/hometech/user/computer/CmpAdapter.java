package com.example.hometech.user.computer;
...
public class CmpAdapter extends RecyclerView.Adapter<CmpAdapter.MyViewHolder>implements Filterable {
    private LayoutInflater inflater;
    private ArrayList<CmpData> dataModelArrayList;
    private ArrayList<CmpData> dataModelArrayListFiltered;
    Context c;

    public CmpAdapter(Context ctx, ArrayList<CmpData> dataModelArrayList) {
        c = ctx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final CmpData product = dataModelArrayListFiltered.get(position);
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CmpData p = dataModelArrayList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<CmpData> filteredList = new ArrayList<>();
                    for (CmpData row : dataModelArrayList) {
