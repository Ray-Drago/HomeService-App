...
public class CmpList extends AppCompatActivity {
    ...
    String url = Config.baseURL+"computer.php";
    CmpAdapter cmpAdapter;
    ArrayList<CmpData>arrayList;
    Context c ;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(CmpList.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void setupRecycler(){
        ...
        cmpAdapter = new CmpAdapter(this,arrayList);
