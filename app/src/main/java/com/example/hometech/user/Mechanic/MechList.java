...
public class MechList extends AppCompatActivity {
    RecyclerView recyclerView;
    static ProgressDialog progressDialog;
    String url = Config.baseURL+"mechanic.php";
    MechAdapter cmpAdapter;
    ArrayList<MechData>arrayList;
    Context c ;
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(MechList.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void setupRecycler(){
        ...
        cmpAdapter = new MechAdapter(this,arrayList);
