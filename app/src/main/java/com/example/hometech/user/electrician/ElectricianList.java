...
public class ElectricianList extends AppCompatActivity {
    ...
    String url = Config.baseURL+"electrician.php";
    ElectricianAdapter electricianAdapter;
    ArrayList<ElectricianData>arrayList;
    Context c ;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                electricianAdapter.getFilter().filter(query);
                return false;
            }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                       ...
                       // Toast.makeText(UserListActivity.this, response, Toast.LENGTH_SHORT).show();
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                arrayList.add(new ElectricianData(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(ElectricianList.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void setupRecycler(){
        ...
        electricianAdapter = new ElectricianAdapter(this,arrayList);
