...
public class LaundryAdapter extends RecyclerView.Adapter<LaundryAdapter.MyViewHolder>implements Filterable {
    private LayoutInflater inflater;
    private ArrayList<LaundryData> dataModelArrayList;
    private ArrayList<LaundryData> dataModelArrayListFiltered;
    Context c;

    public LaundryAdapter(Context ctx, ArrayList<LaundryData> dataModelArrayList) {
        c = ctx;
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        final LaundryData product = dataModelArrayListFiltered.get(position);
        ...
        holder.view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                LaundryData p = dataModelArrayList.get(position);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<LaundryData> filteredList = new ArrayList<>();
                    for (LaundryData row : dataModelArrayList) {
