...
public class TechShoppingList extends AppCompatActivity {
    RecyclerView recyclerView;
    static ProgressDialog progressDialog;
    String url = Config.baseURL+"new/product_list.php";
    ArrayList<techProductListModel> arrayList;
    Context c ;
    TechProduct_Adapter techProduct_adapter;
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                ...
                techProduct_adapter.getFilter().filter(query);
                return false;
            }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_shopping_list);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET,url,
                        ...
                        try {
                           // Toast.makeText(getApplicationContext(), response, Toast.LENGTH_SHORT).show();
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                arrayList.add(new techProductListModel(
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(TechShoppingList.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void setupRecycler(){
        ...
        techProduct_adapter = new TechProduct_Adapter(this,arrayList);
        recyclerView.setHasFixedSize(true);
        recyclerView.setAdapter(techProduct_adapter);
