...
public class techViewProductActivity extends AppCompatActivity {
...
Button btnBuy,btnCart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> user = new TechSession(techViewProductActivity.this).getUserDetails();
...
//        setValues();
        ...
        btnCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), techAddToCartActivity.class);
...
//                i.putExtra("img",image);
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(getApplicationContext(), TechConfirmBuyActivity.class);
                i.putExtra("product_price", price);
                i.putExtra("product_name", name);
                i.putExtra("product_image", image);
                i.putExtra("product_quantity", quantity);
