...
public class techAddToCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_add_to_cart);
...
//        upload = i.getStringExtra("upload");
        ...
        btnBuy.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(techAddToCartActivity.this, "Adding to cart...", Toast.LENGTH_SHORT).show();
                addData();
            }
        });
        ...
        StringRequest s = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        if (status.equals("1")) {
                            Toast.makeText(techAddToCartActivity.this, "Added to cart", Toast.LENGTH_SHORT).show();
                            finish();
                        } else {
                            Toast.makeText(techAddToCartActivity.this, "Network error", Toast.LENGTH_SHORT).show();
                        }
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(techAddToCartActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
