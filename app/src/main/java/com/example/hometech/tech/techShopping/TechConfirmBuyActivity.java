...
public class TechConfirmBuyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tech_confirm_buy);
    ...
    public void sendOTP() {
        ...
        String msg = "Welcome Your OTP for confirm your oder  " + otp;

        SmsManager sms = SmsManager.getDefault();
        sms.sendTextMessage(phone, null, msg, null, null);

        Intent i = new Intent(TechConfirmBuyActivity.this, TechOtp.class);
    ...
    {
        if (ContextCompat.checkSelfPermission(TechConfirmBuyActivity.this, Manifest.permission.SEND_SMS) == PackageManager.PERMISSION_DENIED) {

            // Requesting the permission
            ActivityCompat.requestPermissions(TechConfirmBuyActivity.this, new String[] { Manifest.permission.SEND_SMS }, 1);
        }
        else {
            sendOTP();
        }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults)
    {
        ...
        if (requestCode == 1) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Toast.makeText(TechConfirmBuyActivity.this, "SMS Permission Denied", Toast.LENGTH_SHORT).show();
            }
        }
    }
